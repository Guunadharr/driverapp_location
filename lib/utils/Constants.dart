...
const mAppName = 'mtaxi driver';
var errorThisFieldRequired = 'This field is required';

const googleMapAPIKey = 'AIzaSyDKzSv7kFtDONzdSL3xH0sqMvMx2IkBmgA';

const DOMAIN_URL =
    'http://192.168.29.30:8000'; // Don't add slash at the end of the url
const mBaseUrl = "$DOMAIN_URL/api/";

final client = MqttServerClient.withPort("broker.hivemq.com", "", 1883);

const mOneSignalAppIdRider = 'f91a2c64-7c2d-4524-ad53-3eaf59bc2224';
const mOneSignalRestKeyRider =
    'OTcxYjk3NzktMzA1Yi00ZjE5LTljNzctYjI2M2E2NzBkMTcx';

const mOneSignalAppIdDriver = '1e3de26d-e9b4-43df-8a89-aeeccd85fd9c';
const mOneSignalRestKeyDriver =
    'ZTdhNTMyZmYtNTdmMy00YjI3LTliZmYtNTNjMzAzOTIxZWY2';
